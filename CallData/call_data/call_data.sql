...
//不显示finalBev=5002和5003的数据
select ver,platform,channel,Week(inviteStart) as week,ringStart,talkStart,finalBev from clientCallerVoipCallLog_%s where Date(inviteStart) = %s and finalBev!='5002' and finalBev!='5003';
